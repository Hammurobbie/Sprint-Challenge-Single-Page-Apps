...
> Answer: This allows changes to render on the page without refeshing the entire page. Only the component being affected will be changed. Al this without communicating with the server.
